...
let results = alphabetString.split();
console.log(results)
...
let reverseAlpha = alphabetArray.reverse();
console.log(reverseAlpha);

let joinedAlpha = alphabetArray.join();
...
console.log('Step 3: ' + array1.at(-1))
array1.push(16, 3)
console.log('Step 4: ' + array1)
console.log('Step 5: ' + array1[2])
console.log('Step 6: ' + array1.at(-1))
...
myTodoList.push('Replace Front Door', 'Fix Window Trim', 'Fix Storage Room Leak');
console.log(myTodoList);

myTodoList.splice(1, 1);
console.log(myTodoList);

let yourToDoList = ['Clean Bathrooms', 'Seal front porch'];
